...
export const WhatsAppIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path d="M16.75 13.96c.25.13.42.2.46.2a.37.37 0 0 1 .1.28c-.05.28-.2.5-.28.58a.4.4 0 0 1-.2.13c-.08.03-.5.18-1-.1a4.8,4.8,0,0,1-1.7-1,6.56,6.56,0,0,1-1.1-1.45.24.24,0,0,1,0-.2,1,1,0,0,1,.3-.42c.1-.1.2-.25.3-.4A.49.49,0,0,0,13.6,11c0-.1,0-.25-.08-.38s-.2-.2-.4-.2h-.5a1,1,0,0,0-.7.3,1.4,1.4,0,0,0-.4,1c0,.45.15.85.3 1.2a6.4,6.4,0,0,0,1,1.3,7.7,7.7,0,0,0,1.5,1.1,5.26,5.26,0,0,0,1.8.7,3.1,3.1,0,0,0,1-.2,2.1,2.1,0,0,0,1.2-.9c.2-.3.2-.6.1-.8s-.2-.3-.4-.4ZM12,2a10,10,0,0,0-10,10,10,10,0,0,0,10,10,9.9,9.9,0,0,0,7.5-3.5,1,1,0,0,0,0-1.2L18,15.8a1,1,0,0,0-1.2,0,7.9,7.9,0,0,1-10-10,1,1,0,0,0,0-1.2L8.2,3.1A1,1,0,0,0,7,2.5,9.9,9.9,0,0,0,12,2Zm0,18a8,8,0,1,1,8-8A8,8,0,0,1,12,20Z"/>
    </svg>
);
...
export const GrabberIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <line x1="10" y1="8" x2="21" y2="8"></line>
...
export const MegaphoneIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M3 11v2a2 2 0 0 0 2 2h2l9.4 6.6A2 2 0 0 0 19 20V4a2 2 0 0 0-2.6-1.6L6 9H5a2 2 0 0 0-2 2z"></path>
...
export const MessageSquareTextIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path>
    <path d="M13 8H7"></path>
